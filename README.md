# JSI GraphBasedAnalytics OpenAPI Specification
...
6. If you did everything correct, https://jsi-eubusinessgraph.github.io/jsi-graph-based-analytics-api/ will lead to your new docs
...
- Documentation(ReDoc): https://jsi-eubusinessgraph.github.io/jsi-graph-based-analytics-api/
...
- Preview spec version for branch `[branch]`: https://jsi-eubusinessgraph.github.io/jsi-graph-based-analytics-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://jsi-eubusinessgraph.github.io/jsi-graph-based-analytics-api/ with url from the message: `Server started <url>`
